...
@Component({
  ...
  standalone: true,
  imports: [ChartModule],
  templateUrl: './month-comparison-chart.component.html',
  styleUrl: './month-comparison-chart.component.css'
})
export class MonthComparisonChartComponent implements OnChanges{
